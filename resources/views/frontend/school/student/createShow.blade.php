                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive " id="printDiv">
                            <table id="example" class="table text-center" style="width:100%">
                                <thead >
                                    <tr>
                                        <th class="printHide"><input type="checkbox" id="select_all_ids" class="printHide"></th>
                                ...
                                <tbody class="" style="line-height: 100%" >
                                    ...
                                    <tr id="student_ids{{$data->id}}">
                                        <td class="printHide"><input type="checkbox" class="check_id" name="ids" value="{{$data->id}}"></td>
                                                                ...
                                                                <div class="col-12 mt-4">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-5">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="{{__('app.Student')}} {{__('app.Name')}}" name="name" value="{{$data->name}}" required>
                                                                        </div>
                                                                        <div class="col-md-5">
                                                                            <label class="form-label-edit">{{__('app.RollNumber')}} <span style="color:red;">*</span></label>
                                                                            <input type="text" class="form-control" placeholder="{{__('app.RollNumber')}}" name="roll_number" value="{{$data->roll_number}}" required>
                                                                        </div>
                                                                        <div class="col-md-1"></div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-12 mt-4">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-5">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="{{__('app.Email')}}" name="email" value="{{$data->email}}" required>
                                                                        </div>
                                                                        <div class="col-md-5">
                                                                            <label class="form-label-edit">{{__('app.PhoneNumber')}} <span style="color:red;">*</span></label>
                                                                            <input type="text" class="form-control" placeholder="{{__('app.PhoneNumber')}}" name="phone" value="{{$data->phone}}" required>
                                                                        </div>
                                                                        <div class="col-md-1"></div>
                                                                ...
                                                                <div class="col-12 mt-4">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-5">
                                                                            ...
                                                                            <input type="date" id="datepicker" class="form-control" name="dob" value="{{$data->dob}}" required>
                                                                        </div>
                                                                        <div class="col-md-1"></div>
                                                                ...
                                                                <div class="col-12 mt-4">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-5">
                                                                            ...
                                                                            <input type="radio" id="Male" name="gender" value="Male" {{($data->gender == 'Male') ? 'checked' : '' }} required>
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            ...
                                                                            <select class="form-control mb-3" name="shift" required>
                                                                ...
                                                                <div class="col-12 mt-4">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md">
                                                                            ...
                                                                            <select class="form-control mb-3" name="class_id" id="edit_class_id{{ $data->id }}" onchange="loadSection();" js-select required>
                                                                        ...
                                                                        <div class="col-md">
                                                                            ...
                                                                            <select class="form-control mb-3" id="section_id" name="section_id" required>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        @if (in_array($class_name, classFilter()))
                                                                            <div class="col-md-3  mt-3" id="group-select">
                                                                                ...
                                                                                <select class="form-control mb-3" required name="group_id" id="edit_group_id{{ $data->id }}" js-select>
                                                                ...
                                                                <div class="col-12 mt-4">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-5">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="Father name" name="father_name" value="{{$data->father_name}}" required>
                                                                        </div>
                                                                        <div class="col-md-5">
                                                                            <label class="form-label-edit">{{__('app.Mother Name')}} <span style="color:red;">*</span></label>
                                                                            <input type="text" class="form-control" placeholder="Mother name" name="mother_name" value="{{$data->mother_name}}" required>
                                                                        </div>
                                                                        <div class="col-md-1"></div>
                                                                ...
                                                                <div class="col-12 mt-4">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-5">
                                                                            ...
                                                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" value="{{$data->address}}" name="address"></textarea>
                                                                        </div>
                                                                        <div class="col-md-5">
                                                                            <label class="form-label-edit">{{__('app.Discount')}}% <span style="color:red;"></span></label>
                            ...
                            <div class="row" style="margin-top: -35px;margin-bottom: 10px;">
                                <div class="col-lg-6">
                                    ...
                                    <button type="button" onclick="printDiv()" class="btn btn-primary btn-sm  ms-2 printHide">
